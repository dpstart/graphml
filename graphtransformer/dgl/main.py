...
def run(args, g):
   ...
   # )
    ...
    for epoch in range(args.epochs):
        loss, acc, optimizer = train_iter(model, g, optimizer, args.device, epoch)
...
def main():
    ...
    parser.add_argument("--init_lr", help="Please give a value for init_lr", default=0.0007)
    parser.add_argument(
    ...
    parser.add_argument("--hidden_dim", help="Please give a value for hidden_dim", default=64)
    parser.add_argument("--out_dim", help="Please give a value for out_dim", default=64)
    parser.add_argument("--edge_feat", help="Please give a value for edge_feat")
    parser.add_argument("--readout", help="Please give a value for readout")
    parser.add_argument("--num_heads", help="Please give a value for n_heads",default=8)
    parser.add_argument(
        "--in_feat_dropout", help="Please give a value for in_feat_dropout",default=0.1
    )
    parser.add_argument("--dropout", help="Please give a value for dropout", default=0.1)
